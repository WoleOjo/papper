      ...
      <Modal.Body className='px-0 py-2 py-sm-0'>
        ...
        <div className='row mx-0 align-items-center'>
          <div className='col-md-6 border-end-md p-4 p-sm-5'>
            <h2 className='h3 mb-4 mb-sm-5'>Join Papperboy.<br />Invest in Africa's growth:</h2>
            <ul className='list-unstyled mb-4 mb-sm-5'>
              <li className='d-flex mb-2'>
                <i className='fi-check-circle text-primary mt-1 me-2'></i>
                <span>Search and find top projects</span>
              </li>
              <li className='d-flex mb-2'>
                <i className='fi-check-circle text-primary mt-1 me-2'></i>
              ...
              <li className='d-flex mb-0'>
                <i className='fi-check-circle text-primary mt-1 me-2'></i>
                <span>Easily manage your investments</span>
              </li>
            </ul>
          ...
          <div className='col-md-6 px-4 pt-2 pb-4 px-sm-5 pb-sm-5 pt-md-5'>
            ...
            <Form noValidate validated={validated} onSubmit={handleSubmit}>
              ...
              <Form.Check
                type='checkbox'
                id='terms-agree'
                label={[<span key={1}>By joining, I agree to the </span>, <Link key={2} href='#'><a>Terms of use</a></Link>, <span key={3}> and </span>, <Link key={4} href='#'><a>Privacy policy</a></Link>]}
                required
                className='mb-4'
              />
