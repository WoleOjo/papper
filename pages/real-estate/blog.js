  ...
  return (
    ...
    >
      <Container className='mt-5 mb-md-4 py-5'>
        ...
        <h1 className='d-flex align-items-end justify-content-between mb-0'>Top Offers</h1>
          ...
          {sponsoredPosts.map((post, indx) => (
            <SwiperSlide key={indx} className='d-flex py-4 bg-white'>
              <Row as='article' className='gy-3'>
                ...
                <Col xs={12} md={5} lg={4}>
                  <Link href={post.category[0]} passHref>
                    <a className='fs-sm text-uppercase text-decoration-none'>
                      {post.category[1]}
                    </a>
                  </Link>
                  ...
                  <Link href={post.author[0]} passHref>
