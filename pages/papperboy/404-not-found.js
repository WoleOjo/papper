...
const NotFoundPage = () => {
  ...
  return (
    <>
      ...
      <Head>
        <title>Papperboy | 404 Not Found</title>
      </Head>
          ...
          <Container className="d-flex justify-content-center text-center">
            <Col xs={12} md={10} lg={8} className="px-0">
              ...
              <h1 className="h3 pt-lg-4">
                Sorry, the content you are looking for is under development.
              </h1>

              <Link href="/papperboy" passHref>
                <Button
                  size="lg"
                  variant="primary rounded-pill w-sm-auto w-100 mb-3 me-sm-4"
                >
                  Go to homepage
                </Button>
              </Link>
              <Link href="/papperboy/contacts" passHref>
                <Button
                  size="lg"
                  variant="outline-primary rounded-pill w-sm-auto w-100 mb-3"
                >
                  Contact us
                </Button>
              </Link>
