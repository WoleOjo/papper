    ...
    >
      ...
      <Container className='my-5 py-lg-5 py-4'>
        ...
        <Row as='section' className='gy-4 pb-5 mb-2 mb-lg-4'>
          <Col md={6}>
            <ImageLoader
              src='/images/papperboy/contacts/01.svg'
              width={743}
              height={713}
              alt='Cover image'
              className='rounded-3'
            ...
            >
              ...
              <Col as={Form.Group} controlId='c-subject'>
                ...
                <Form.Select size='lg' required>
                  ...
                  <option value='Subject 1'>Listings</option>
                  <option value='Subject 2'>Investment 2</option>
                  <option value='Subject 3'>Partnership</option>
                </Form.Select>
                <Form.Control.Feedback type='invalid'>
          ...
          <Col>
            <IconBox
              ...
              text={<>
                ...
                <span className='h4 icon-box-title mb-0 opacity-90'>info@papperboy.com</span>
              </>}
            />
          </Col>
          <Col>
            <IconBox
              ...
              text={<>
                ...
                <span className='h4 icon-box-title mb-0 opacity-90'>(+49) 1626-529-242</span>
              </>}
            />
          </Col>
          <Col>
            <IconBox
              ...
              text={<>
                ...
                <span className='h4 icon-box-title mb-0 opacity-90'>@Papperboy_official</span>
              </>}
            />
          </Col>
        </Row>
